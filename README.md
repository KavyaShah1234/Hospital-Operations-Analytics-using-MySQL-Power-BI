...
SQL-based healthcare analytics project using MySQL (CTEs, joins, aggregations) to answer relevant business questions and provides conclusion on the result
## 🛠️ Tech Stack
